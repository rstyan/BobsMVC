...
//        String("setString", Types.VARCHAR, String::class.java, DesignType::class.java),
    ...
    constructor(v: Any) {
        this.type = toBindingType(v::class.java)
    ...
    companion object {
        ...
        fun toSqlType(value: Any): Any {
            if (value::class.java.equals(java.util.Date::class.java)) {
                return Timestamp((value as java.util.Date).getTime())
            } else if (value.::class.java.equals(DesignType::class.java)) {
        ...
        fun fromSqlType(value: Any?, type: Class<*>): Any? {
